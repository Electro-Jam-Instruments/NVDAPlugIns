# PowerPoint UIA Focus Management - Expert Knowledge

## Overview

PowerPoint-specific UIA patterns for focusing the Comments pane and task pane elements. For general UIA concepts and APIs, see `docs/experts/expert-uia.md`.
