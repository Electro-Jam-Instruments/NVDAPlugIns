...
|--------|--------------|--------|------|
| **PowerPoint Comments and Notes** | Hear comment counts and presenter notes in edit mode and slideshow mode | [stable](https://electro-jam-instruments.github.io/NVDAPlugIns/downloads/powerpoint-comments-latest.nvda-addon) | [beta](https://electro-jam-instruments.github.io/NVDAPlugIns/downloads/powerpoint-comments-latest-beta.nvda-addon) |
...
1. Click the **Download** link for the plugin you want
...
Visit our community forum at **[community.electro-jam.com](https://community.electro-jam.com)**

The forum is built to be keyboard-friendly, so you can navigate and participate without reaching for the mouse.

## Plugin Details

Each plugin has its own documentation with full feature lists and keyboard shortcuts:
