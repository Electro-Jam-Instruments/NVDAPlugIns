...
|--------|---------|-----------|
| PowerPoint Comments | 0.0.79-beta | [powerpoint-comments/CHANGELOG.md](powerpoint-comments/CHANGELOG.md) |
...
#### Plugins Included
- **PowerPoint Comments** v0.0.79-beta - Comment navigation and slide notes for PowerPoint
